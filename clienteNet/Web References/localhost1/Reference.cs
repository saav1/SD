...
namespace clienteNet.localhost1 {
    using System;
    ...
    public partial class Sensor : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback readSensorOperationCompleted;
        ...
        /// <remarks/>
        public Sensor() {
            this.Url = global::clienteNet.Properties.Settings.Default.clienteNet_localhost1_Sensor;
        ...
        /// <remarks/>
        public event readSensorCompletedEventHandler readSensorCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("urn:readSensor", RequestNamespace="http://sonda", ResponseNamespace="http://sonda", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        [return: System.Xml.Serialization.XmlElementAttribute("return")]
        public int readSensor([System.Xml.Serialization.XmlElementAttribute(IsNullable=true)] string file) {
            object[] results = this.Invoke("readSensor", new object[] {
                        file});
            return ((int)(results[0]));
        }
        
        /// <remarks/>
        public void readSensorAsync(string file) {
            this.readSensorAsync(file, null);
        }
        
        /// <remarks/>
        public void readSensorAsync(string file, object userState) {
            if ((this.readSensorOperationCompleted == null)) {
                this.readSensorOperationCompleted = new System.Threading.SendOrPostCallback(this.OnreadSensorOperationCompleted);
            }
            this.InvokeAsync("readSensor", new object[] {
                        file}, this.readSensorOperationCompleted, userState);
        }
        
        private void OnreadSensorOperationCompleted(object arg) {
            if ((this.readSensorCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.readSensorCompleted(this, new readSensorCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.3752.0")]
    public delegate void readSensorCompletedEventHandler(object sender, readSensorCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.3752.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class readSensorCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal readSensorCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
