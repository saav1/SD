...
public class Servidor{
	...
	/*
	  Lee datos del socket. Supone que se le pasa buffer con hueco suficiente para los datos.
	  Devuelve el número de bytes leidos, 0 si e cierra el fichero y -1 si hay error.
	*/
	public String leeSocket(Socket p_sk, String p_Datos){
		...
		{
			System.out.println("Error en lee Socket: " + e.toString());
		}
	...
	*/
	public void escribeSocket(Socket p_sk, String p_Datos){
		...
		{
			System.out.println("Error en escribe Socket: " + e.toString());
		}
		...
		try
		{
			...
			while(true)
			{
				...
				while(resultado != -1) //Mientras resultado no de un error(-1) se mantiene el bucle.
				{
					...
					//Se realiza las operaciones según la Cadena leida y se devuelve el resultado en el l
					//socket Cliente.
